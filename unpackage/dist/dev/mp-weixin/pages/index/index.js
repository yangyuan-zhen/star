  ...
  setup(__props) {
    ...
    const getWeatherData = async (locationId) => {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/index/index.vue:64", "获取天气数据失败:", error);
    ...
    const getLocation = () => {
      ...
      return new Promise((resolve, reject) => {
        common_vendor.index.authorize({
            ...
            common_vendor.index.getLocation({
              ...
              success: async (res) => {
                try {
                  ...
                  common_vendor.index.__f__("error", "at pages/index/index.vue:100", "位置信息处理失败:", error);
                  city.value = "未知位置";
              ...
              fail: (err) => {
                common_vendor.index.__f__("error", "at pages/index/index.vue:107", "获取位置失败:", err);
                city.value = "未知位置";
                getWeatherData();
                reject(err);
              }
          ...
          fail: (err) => {
            common_vendor.index.__f__("error", "at pages/index/index.vue:115", "位置授权失败:", err);
    ...
    const init = async () => {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/index/index.vue:140", "初始化位置或天气失败:", error);
      }
    };
